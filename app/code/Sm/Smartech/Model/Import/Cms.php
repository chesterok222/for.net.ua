...
namespace Sm\Smartech\Model\Import;
...
class Cms
{
    ...
    public function __construct(
        ...
        $this->_importPath = BP . '/app/code/Sm/Smartech/etc/import/';
    ...
    public function importCms($type)
    {
        ...
        try {
            ...
            if($this->_scopeConfig->getValue("smartech/theme_install/overwrite_".$type)) {
                $overwrite = true;
            }
