...
class Data extends AbstractHelper
{
	...
	{		
		...
		if (strpos($file, $path_http) === false){
			$path_http2 = $this->_storeManager->getStore()->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_STATIC).'frontend';
			$_file_name2 = str_replace($path_http2, '', $file);
			$absPath = $baseDirPub.'static/frontend'.$_file_name2;
		}else{
			$_file_name2 = str_replace($path_http, '', $file);
			$absPath = $_media_dir.$_file_name2;
		}
